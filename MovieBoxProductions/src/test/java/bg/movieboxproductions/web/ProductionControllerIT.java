...
import bg.movieboxproductions.MovieBoxProductionsApplication;
...
@SpringBootTest(classes = MovieBoxProductionsApplication.class)
@AutoConfigureMockMvc
public class ProductionControllerIT {

    //Define SpringBootTest who builds the whole application context including the controller (ProductionController)
    ...
    public void testProductionNotFound() throws Exception {
        mockMvc
                .perform(get("/productions/{id}", "9999")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    public void testCreateProduction() throws Exception {
        ...
        Assertions.assertEquals("Alien: Romulus", production.getName());
    ...
    public void testDeleteProduction() throws Exception {
        ...
        Assertions.assertTrue(
                productionRepository.findById(actualEntity.getId()).isEmpty()
        );
    }
